          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Kyou.id is the number 1 hobby marketplace in Indonesia. Find thousands of original figures, nendoroids, and model kits at the best price.
              </p>
            </div>
            <div>
              <h4 className="font-bold text-slate-800 mb-4 text-sm">Help</h4>
              <ul className="text-xs text-slate-500 space-y-2">
                <li className="hover:text-blue-600 cursor-pointer">How to Order</li>
                <li className="hover:text-blue-600 cursor-pointer">Shipping</li>
                <li className="hover:text-blue-600 cursor-pointer">Payment</li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold text-slate-800 mb-4 text-sm">About</h4>
              <ul className="text-xs text-slate-500 space-y-2">
                <li className="hover:text-blue-600 cursor-pointer">About Kyou</li>
                <li className="hover:text-blue-600 cursor-pointer">Careers</li>
                <li className="hover:text-blue-600 cursor-pointer">Blog</li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold text-slate-800 mb-4 text-sm">Follow Us</h4>
