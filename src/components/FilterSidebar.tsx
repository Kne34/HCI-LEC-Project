...
const FilterSidebar: React.FC<FilterSidebarProps> = ({ 
  ...
  return (
    <aside className="w-64 flex-shrink-0 hidden lg:block">
      <div className="sticky top-24 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm overflow-y-auto max-h-[calc(100vh-120px)] scrollbar-thin scrollbar-thumb-slate-200">
